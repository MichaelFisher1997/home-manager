...
## Build/Test Commands
- **Build configuration**: `home-manager switch --flake .#hypr-nix`
- **Check configuration**: `home-manager build --flake .#hypr-nix`
...
## Testing
- Test changes by running `home-manager switch --flake .#hypr-nix`
